...
\begin{tabular}{|l|p{10cm}|p{3cm}|} 
  ...
  \texttt{evodivparam}	& parametric diversity indices applied to phylogenetic diversity \citep{PavoineRicotta2019a} & \texttt{plot.evodivparam} \\
    \hline
  \texttt{FPdivparam}	&   Parametric Indices of Functional and Phylogenetic Diversity \citep{PavoineRicotta2021}  & \texttt{plot.FPdivparam} \\
    \hline
...
Main function	& Aim	& Associated functions \\
  ...
  \texttt{dsimcom} & \citet{PavoineRicotta2014} generalization of compositional similarity indices such as Jaccard and S\o rensen indices to include information on functional and phylogenetic similarity between species and abundance data for each species & sQ \\
     \hline
  \texttt{dislptransport} & \citet{Kosman1996} and \citet{Gregoriusetal2003} coefficient of the dissimilarities between communities \citep{Ricottaetal2021a} &  \\
     \hline
...
phylogenetic) uniqueness across two communities (functions \texttt{betaUniqueness} and \texttt{betaTreeUniqueness}, Table \ref{tab:ori}). 
...
\texttt{distinctUltra} & species' originality that rely on the structure and branch lengths of ultrametric (phylogenetic) trees \citep{Pavoineetal2005, PavoineIzsak2014} & \texttt{orisaved} \\
   \hline
\multicolumn{3}{|l|}{Abundance-weighted originality (=distinctiveness) of each species at a given place} \\
   \hline
\texttt{distinctAb} & dissimilarity- and abundance-based species' originality \citep{PavoineRicotta2021} & \\
   \hline
...
\texttt{treeUniqueness} & community-level phylogenetic (or tree-based) redundancy taking into account the branching pattern of the underlying phylogenetic tree (or any other tree, like a functional dendrogram) \citep{Ricottaetal2018, PavoineRicotta2019a} & \\	
   \hline
\texttt{betaUniqueness} & \citet{Ricottaetal2021a} plot-to-plot functional $\beta$ uniqueness & \\
   \hline
...
that contains bat phylogenies (below we use 
\texttt{batcomm\$tre}) and bat abundances (below we use \texttt{batcomm\$ab}) along a disturbance gradient in a neotropical 
...
plantations (P), oldfields (O) and cornfields (C). The phylogeny we use below is \citet{Fritzetal2009} 
...
\bibitem[Gregorius et al.(2003)]{Gregoriusetal2003} Gregorius, H.-R., Gillet, E.M., Ziehe, M. (2003) Measuring differences of trait distributions between populations. \emph{Biometrical Journal}, 8, 959--973 \url{https://doi.org/10.1002/bimj.200390063}
...
\bibitem[Kosman(1996)]{Kosman1996} Kosman, E. (1996) Difference and diversity of plant pathogen populations: a new approach for measuring. \emph{Phytopathology}, 86, 1152--1155.
...
\bibitem[Pavoine and Ricotta(2021)]{PavoineRicotta2021} Pavoine,~S., Ricotta,~C. (2021) On the relationships between rarity, uniqueness, distinctiveness, originality and functional/phylogenetic diversity. \emph{BiorXiv}. \url{https://doi.org/10.1101/2021.08.09.455640}
...
\bibitem[Ricotta et al.(2020)]{Ricottaetal2020} Ricotta,~C., Laroche,~F., Szeidl,~L., Pavoine,~S. (2020) From alpha to beta functional and phylogenetic redundancy. \emph{Methods in Ecology and Evolution}, 11, 487--493. \url{https://doi.org/10.1111/2041-210X.13353}
\bibitem[Ricotta et al.(2021)]{Ricottaetal2021a} Ricotta,~C., Kosman,~E., Laroche,~F., Pavoine,~S. (2021) Beta redundancy for functional ecology. \emph{Methods in Ecology and Evolution}, 12, 1062--1069. \url{https://doi.org/10.1111/2041-210X.13587}
